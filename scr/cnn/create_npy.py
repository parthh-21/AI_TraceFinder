...
FLATFIELD_DIR = r"C:\Users\parth\Desktop\AI_track_finder\dataset\Flatfield"
OUT_DIR = r"C:\Users\parth\Desktop\AI_track_finder\processed_data\new_processed"
...
def create_flatfield_npy():
    ...
    for label, device in enumerate(sorted(os.listdir(FLATFIELD_DIR))):
        ...
        count = 0
        # flatfield images are directly inside device folder
