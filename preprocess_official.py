...
# ✅ Change this path to your Official dataset location
DATASET_OFFICIAL = "Official-20250910T085215Z-1-001/Official"
...
def compute_metadata_features(img, file_path, scanner_id, resolution="unknown"):
    """Compute statistical + edge features"""
    h, w = img.shape
    aspect_ratio = w / h
...
def preprocess_official_dataset(official_dir, out_dir, csv_path):
    ...
    with open(csv_path, "w", newline="") as csvfile:
        ...
        for root, dirs, files in os.walk(official_dir):
            ...
            # infer scanner_id from parent folder
